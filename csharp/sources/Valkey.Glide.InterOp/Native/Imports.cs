...
public static class Imports
{
    ...
    /// <c>void Callback(void * in_data, int out_success, const Value ref_value)</c>.
    ...
    /// the third arg contains either the result and MUST be freed by the callback before exiting the callback!
    /// </param>
